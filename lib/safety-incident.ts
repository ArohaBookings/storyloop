...
const LOCAL_HIT_KICK_SAFETY_PATTERN =
  /(?:\b(?:hit(?:s|ting)?|kicked?|kick(?:s|ing)?)\b[^.!?\n]{0,100}\b(?:didn'?t like|did not like|unacceptable|not safe|unsafe|hurt|cry(?:ing)?|cried|upset|angry|stop|conflict|argument|fight|rough|physical)\b|\b(?:unsafe|hurt|cry(?:ing)?|cried|upset|angry|conflict|argument|fight|rough|physical)\b[^.!?\n]{0,100}\b(?:hit(?:s|ting)?|kicked?|kick(?:s|ing)?)\b)/i;
