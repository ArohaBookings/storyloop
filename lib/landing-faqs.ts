...
export const LANDING_FAQS: LandingFaq[] = [
  ...
  { q: "What about children's privacy?", a: "Your observations are not used to train AI models. Children's voice recordings are never stored, and anything shared with families outside StoryLoop carries no names, photographs or dates. Nothing is shared until you choose to." },
