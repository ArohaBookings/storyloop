...
export const LANDING_FAQS: LandingFaq[] = [
  ...
  { q: "How much does it cost?", a: "Three stories a month are free with no card. Educator is NZ$21 or A$19 a month for unlimited stories. Centre Starter covers up to 10 educators and unlimited children for NZ$109 or A$99 a month. Paid plans start with a 7-day free trial and cancel anytime." },
  ...
  { q: "What about children's privacy?", a: "Your observations are not used to train AI models. StoryLoop never keeps children's voice recordings, and anything shared with families outside StoryLoop carries no names, photographs or dates. Nothing is shared until you choose to." },
