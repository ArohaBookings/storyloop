...
export const LANDING_FAQS: LandingFaq[] = [
  ...
  { q: "Does it work with Storypark or Educa?", a: "Yes. Write and check the story in StoryLoop, then share it wherever your families already are, including Storypark, Educa, Kinderloop and Brightwheel. Centres that want one home for their learning stories can also keep them all in StoryLoop, with family versions and wall cards in eleven languages." },
  ...
  { q: "How do I know it will not make things up?", a: "Every draft shows what it rests on from your note and lists what it assumed, so you can check both before sharing. And every change to how stories are written is tested first on the same 24 notes: in the latest test, every child's quote in all 48 drafts matched the educator's note word for word. The full results, including what is still being improved, are in the accuracy report at storyloop.space/accuracy." },
