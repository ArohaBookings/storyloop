...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  const staticPages = ["", "about", "resources", "examples", "ai-policy", "documentation-time-calculator", "review-readiness-check", "learning-story-data", "accuracy", "privacy", "terms", "blog", "features", "what-is-a-learning-story", "eylf-learning-outcomes", "learning-story-template", "safety", "works-alongside", "for-educators", "for-families"];
