  ...
  return (
    <div className="min-h-screen bg-paper">
      ...
      <main className="pt-28">
        ...
        <section className="px-6 pb-16 paper-texture">
          <div className="max-w-5xl mx-auto">
            <p className="section-title mb-4">{page.kicker}</p>
            <h1 className="font-display text-4xl md:text-6xl font-bold text-ink-900 tracking-tight max-w-4xl">
              {page.heading}
            </h1>
        ...
        <section className="px-6 py-16 bg-cream-50 border-y border-clay-100">
