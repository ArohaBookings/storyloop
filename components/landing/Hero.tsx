...
export default function Hero() {
  return (
    <section className="relative pt-28 sm:pt-32 pb-16 sm:pb-20 overflow-hidden paper-texture">
      ...
      <div className="wide-shell relative z-10">
        ...
        <h1 className="mx-auto max-w-6xl font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold text-ink-900 leading-[1.03] tracking-tight text-center mb-6 animate-fade-up-1">
